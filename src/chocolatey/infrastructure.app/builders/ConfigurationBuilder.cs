...
namespace chocolatey.infrastructure.app.builders
{
    ...
    public static class ConfigurationBuilder
    {
        ...
        private static void set_feature_flags(ChocolateyConfiguration config, ConfigFileSettings configFileSettings)
        {
            ...
            config.Features.UseShimGenService = set_feature_flag(ApplicationParameters.Features.UseShimGenService, configFileSettings, defaultEnabled: false, description: "Generates redirect executables in bin folder, so end-user can easily invoke specific executable.");
